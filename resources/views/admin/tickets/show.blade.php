...
<div class="ticket-workspace">
    <a href="{{ url()->previous() }}" class="btn btn-outline-deskcir btn-sm mb-3 d-inline-flex align-items-center gap-2" data-smart-back data-fallback="/admin/tickets">
    ...
    <section class="ticket-hero card border-0 shadow-sm mb-4">
        <div class="card-body p-4 p-lg-5">
            <div class="ticket-hero__grid">
                <div>
                    <p class="ticket-hero__eyebrow">Administracion de soporte</p>
    ...
    <section class="card border-0 shadow-sm mb-4">
        <div class="card-body p-4">
            <div class="d-flex align-items-center gap-2 mb-3">
                <span class="material-symbols-outlined text-deskcir">settings</span>
                <h5 class="fw-bold mb-0">Gestion del ticket</h5>
            </div>
            ...
            @if(!$ticket->technician_id)
                <form method="POST" action="{{ route('admin.tickets.assign',$ticket->id) }}" class="mb-4">
                    ...
                    <div class="row g-2 align-items-end">
                        ...
                        <div class="col-md-4">
                            <button class="btn btn-deskcir w-100 d-inline-flex align-items-center justify-content-center gap-2">
            ...
            <form method="POST" action="{{ route('admin.tickets.status',$ticket->id) }}">
                ...
                <button class="btn btn-deskcir mt-3 d-inline-flex align-items-center gap-2">
        ...
        <div class="card-body p-4">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-3">
                <div>
                    ...
                    <h5 class="fw-bold mb-0">Seguimiento del servicio</h5>
                </div>
